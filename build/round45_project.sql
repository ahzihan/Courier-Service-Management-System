...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2020 at 06:01 AM
...
--
-- Table structure for table `delivery_man_attendance`
--
...
(7, 1, '2020-11-01', 'cash', '20', 2, 'success'),
(8, 1, '2020-11-12', 'cash', '10', 1, 'success'),
(9, 2, '2020-11-12', 'cash', '10', 1, 'success'),
(10, 3, '2020-11-12', 'cash', '20', 2, 'success'),
(11, 3, '2020-11-12', 'cash', '50', 2, 'success'),
(12, 2, '2020-11-12', 'cash', '50', 2, 'success'),
(13, 1, '2020-11-13', 'cash', '20', 1, 'success'),
(14, 2, '2020-11-13', 'bank', '40', 1, 'success');
...
INSERT INTO `orders` (`orderID`, `merchantID`, `date`, `priority`, `pickup_address`, `delivery_address`, `fee`, `status`, `pickup_man`, `delivery_man`, `code`, `pickup_area`, `delivery_area`, `order_type`, `feedback`, `received_by`, `customer_name`, `customer_phone`) VALUES
(1, 1, '2020-10-23', 'normal', 'Jighatola', 'Mohammodpur', '100', 'pending', 5, 5, 'abc111', 1, 1, 'Cash on Delivery', 'good', 1, 'Ashik', '018'),
(2, 2, '2020-10-22', 'normal', 'Mirpur-10', 'Mirpur-2', '100', 'delivered', 2, 2, 'ttt147', 2, 2, 'Cash on Delivery', 'good', 2, 'Shahriar', '019'),
(3, 2, '2020-10-03', 'medium', 'Uttora', 'Bonani', '100', 'delivered', 3, 4, 'ban111', 3, 4, 'Cash on Delivery', 'ok', 2, 'Jahanur', '017'),
(4, 3, '2020-11-04', 'normal', 'Mirpur', 'Dhanmondi', '100', 'delivered', 2, 1, '5677', 2, 1, 'Only Delivery', 'ok', 2, 'Shahin', '018'),
(5, 3, '2020-11-02', 'emergency', 'bonani', 'uttara', '100', 'picked_up', 4, 3, '5677', 4, 3, 'Cash on Delivery', 'ok', 1, 'Mohayminul', '018'),
(7, 2, '2020-11-14', 'normal', '5/A', 'Mirpur road', '', 'pending', 0, 0, '', 1, 2, 'Cash on Delivery', '', 0, 'Siddik', '017');

--
-- Triggers `orders`
--
DELIMITER $$
CREATE TRIGGER `delete_product` AFTER DELETE ON `orders` FOR EACH ROW DELETE FROM order_details WHERE orderID=OLD.orderID
$$
DELIMITER ;
...
--
-- Indexes for table `delivery_man_attendance`
--
ALTER TABLE `delivery_man_attendance`
  ADD PRIMARY KEY (`id`),
  ADD KEY `delivery_manID` (`delivery_manID`);
...
--
-- AUTO_INCREMENT for table `delivery_man_attendance`
--
ALTER TABLE `delivery_man_attendance`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `delivery_man_attendance`
--
ALTER TABLE `delivery_man_attendance`
  ADD CONSTRAINT `delivery_man_attendance_ibfk_1` FOREIGN KEY (`delivery_manID`) REFERENCES `delivery_man` (`dID`) ON DELETE CASCADE ON UPDATE CASCADE;
