...
if (isset($_POST['searchsubmit'])) {
    $result = $obj->check_pickup_report($_POST);
} else {
    if (isset($_GET['id'])) {
        $pickup_man = $obj->get_pickman_details($_GET);
    }
}
?>
<?php
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Pickup Man Report</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Pickup Man Report</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <?php if (isset($pickup_man)) { ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                while ($row = $pickup_man->fetch_assoc()) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $i++; ?></td>
