            ...
            <div class="card">
              <div class="card-header">
                <div class="row justify-content-md-center">
                  <div><h3 style="color: gray">Merchant Payment Ledger </h3></div>
                </div>
                <hr>
                <div class="row">
                  <div class="col-md-6">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td colspan="4"><?php echo $result['total_price']; ?></td>
...
<!-- paid secton in ledger section -->
                <?php 
                $data = $obj->merchant_payment_ledger($_GET['id']);
