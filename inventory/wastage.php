      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Wastage Product List</h3>
            </div>
            <div class="card-body">
              <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-xs btn-primary" href="wastage_details.php?id=<?php echo $row['orderID']?>">View</a>
                    </td>
                  </tr>
                <?php $i++; } ?>
                </tbody>
...
<script>
  $(document).ready(function(){
    $('#order_id').on('change',function(){
      ...
      $.ajax({
        url: 'get_productlist_for_wastage.php',
        method: 'post',
